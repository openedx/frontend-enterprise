...
const LearningTypeRadioFacet = () => {
  ...
  const boldTitle = refinements.content_type && (refinements.content_type.includes(LEARNING_TYPE_COURSE)
      || refinements.content_type.includes(LEARNING_TYPE_PROGRAM));
